...
public class Payment extends javax.swing.JFrame {
    public void tableDetails(){
        ...
        try {
            ...
            while(rs.next()){
                dtm.addRow(new Object[]{rs.getString(3)});
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            Connection con=ConnectionProvider.getcon();
            PreparedStatement ps=con.prepareStatement("insert into payment valures(?,?,?)");
            ps.setString(1, id);
...
//            ResultSet rs1.st.executeQuery("Select *from payment innner join member where payment.month='"+month+"' and payment.id='"+id+"'");
//            while(rs1.next())
//            {
